  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className="flex items-center justify-center gap-3 w-full rounded-lg border border-zinc-800 bg-transparent px-5 py-3 text-[14px] font-medium text-zinc-300 hover:text-white hover:bg-zinc-900 hover:border-zinc-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
