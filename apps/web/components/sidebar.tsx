    ...
    >
      <div className="relative px-3 pt-3 pb-2">
        <button
          ...
          className={cn(
            ...
            collapsed ? "justify-center hover:bg-white/5" : "hover:bg-white/5"
          )}
        >
          ...
          {!collapsed && (
            <div className="flex-1 leading-tight text-left">
              <p className="text-sm font-semibold text-zinc-100">{firstName}&apos;s Workspace</p>
              <p className="text-xs text-zinc-400">Athrean</p>
            </div>
          )}
          {!collapsed && <PanelLeftClose className="h-4 w-4 text-zinc-500 group-hover:text-zinc-300" />}
        </button>
      </div>
      ...
      <div className={cn("px-3 py-3", collapsed ? "flex justify-center" : "")}>
        <div className={cn("flex items-center", collapsed ? "flex-col gap-2" : "gap-3")}>
          ...
          {!collapsed && <img src="/vector-logo.png" alt="Athrean" className="w-7 h-7 object-contain opacity-40 hover:opacity-100 transition-opacity ml-auto grayscale brightness-200" />}
        </div>
      </div>

      <div className="px-3 py-3">
        <form action={signout}>
          <Button variant="ghost" className={cn("w-full justify-start gap-2 rounded-xl px-3 py-2 text-sm font-medium text-zinc-500 hover:text-red-400 hover:bg-red-500/10 transition", collapsed && "justify-center")}>
